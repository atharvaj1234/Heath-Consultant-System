  ...
  useEffect(() => {
    ...
    const fetchBookings = async () => {
      ...
      try {
        ...
        const bid = getAcceptedAppointmentId(data);
        console.log(data);
        setBookingId(bid);

        data = await getUserPayments(token);
        const pid = getAppointmentPaymentId(data, bid);
        setPaymentId(pid);
        console.log(data);
      } catch (err) {
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12}>
              ...
              <Typography variant="body2" paragraph>
                {consultant.consultant.bio || "No bio provided."}
              </Typography>
            </Grid>
            ...
            <Grid item xs={12} md={6}>
              ...
              <Typography variant="body2">
                {consultant.consultant.qualification || "Not specified"}
              </Typography>
            </Grid>
            <Grid item xs={12} md={6}>
              <Typography
              ...
              <Typography variant="body2">
                {consultant.consultant.areasOfExpertise || "Not specified"}
              </Typography>
            </Grid>
            ...
            <Grid item xs={12}>
              <Typography
                ...
                sx={{ display: "flex", alignItems: "center", mb: 1 }}
              >
                <Calendar className="mr-1 w-5 h-5" />
                Availability
              </Typography>
              <Box sx={{ mt: 1 }}>
            ...
            <Grid item xs={12} sx={{ textAlign: "center" }}>
              {userRole === "user" && bookingId != 0 ? (
                paymentId != 0 ? (
                  <Button
                    component={Link}
                    to={`/payment/${consultant?.consultant.id}/${paymentId}`}
                    variant="contained"
                    size="large"
                    sx={{
